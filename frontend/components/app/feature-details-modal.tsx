...
import { type FeatureCategory, featureData } from './feature-data';
                ...
                return (
                  <div
                    ...
                    style={{
                      padding: '16px',
                      borderRadius: 16,
                      border: `1px solid ${isExpanded ? '#0d6e73' : '#e8f7f8'}`,
                      background: isExpanded ? '#f4f8f8' : '#fcfdfd',
                      cursor: 'pointer',
                      transition: 'all 0.2s',
                        ...
                        >
                          <span
                            style={{
                              ...
                              fontWeight: 700,
                              color: '#0d6e73',
                              background: isExpanded ? '#ffffff' : '#e8f7f8',
                              padding: '2px 8px',
                              borderRadius: 999,
                            }}
                          >
