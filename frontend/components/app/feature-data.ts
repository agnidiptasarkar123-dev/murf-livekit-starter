...
export const featureData: FeatureItem[] = [
  ...
  },
  {
    ...
    description:
      'A pension scheme primarily focused on unorganized sector workers, providing a guaranteed minimum pension.',
    fullDetails:
      'The Atal Pension Yojana (APY) provides a guaranteed minimum monthly pension ranging from ₹1,000 to ₹5,000 after reaching the age of 60. It is open to all bank account holders aged between 18 and 40 years. The key benefit is financial security in old age, with the added guarantee that if the subscriber passes away, the spouse will continue to receive the pension. To apply, simply contact the bank where you hold your savings account and fill out the APY registration form.',
  },
  {
    id: 's4',
    category: 'schemes',
  ...
  },
  {
    ...
    description:
      'Provides LPG connection subsidies to women from below poverty line (BPL) households.',
    fullDetails:
      'The Pradhan Mantri Ujjwala Yojana safeguards the health of women and children by providing them with clean cooking fuel. It offers a deposit-free LPG connection in the name of an adult woman belonging to a Below Poverty Line (BPL) household. The primary benefit is reducing health hazards associated with cooking based on fossil fuels. Eligible women can apply by submitting a filled-in application form at any authorized LPG distributor along with their Aadhaar card, ration card, and bank account details.',
  },
  {
    id: 's6',
    category: 'schemes',
  ...
  },
  {
    ...
    description:
      'Crop insurance service for farmers for their yields, aiming to stabilize farmer income.',
    fullDetails:
  ...
  },
  {
    ...
    description:
      'Fraudsters send urgent messages claiming your account will be blocked unless you click a link to update KYC.',
    fullDetails:
      'This fraud pattern involves receiving an urgent SMS or WhatsApp message warning that your bank account, SIM card, or electricity connection will be blocked today if you do not click a link to update your KYC. The link often leads to a fake login page designed to steal your net banking credentials, or they may ask you to download a screen-sharing app. The key warning sign is the manufactured sense of urgency and the inclusion of a suspicious link. Do not click any links or download apps; instead, directly contact your bank or visit your home branch.',
  },
  {
    id: 'f3',
    category: 'fraud',
    ...
    description:
      'Scammers offer high-paying jobs via SMS or WhatsApp but ask for a "registration fee" first.',
    fullDetails:
      'Scammers send unsolicited messages offering easy, high-paying part-time jobs, such as liking YouTube videos or reviewing hotels online. They often pay you a small amount initially to build trust, which is a major warning sign. Eventually, they will ask you to deposit a "registration fee" or pay for "premium tasks" to unlock larger earnings, and then disappear with your money. If you receive such offers, block the sender immediately. Remember that legitimate employers pay you for your work and will never ask you to pay them to start working.',
  },
  {
    id: 'f4',
    category: 'fraud',
  ...
  },
  {
    ...
    description:
      'Fraudsters call to panic you and ask for an OTP. Bank officials will never ask for your OTP.',
    fullDetails:
      'Fraudsters call posing as a bank official, police officer, or telecom executive, trying to create a sense of panic by claiming your card is blocked or suspicious activity was detected. The warning sign is when they ask you to read out an OTP sent to your phone to "verify" your identity or "cancel" a transaction. If this happens, hang up the phone immediately. An OTP is your digital signature, and no legitimate institution will ever ask you to read it out over a call. Sharing it gives the scammer direct access to your funds.',
  },
  ...
  },
  {
    ...
    description:
      'Fixed Deposits are a lump-sum investment, while Recurring Deposits involve depositing a fixed amount monthly.',
    fullDetails:
      'A Fixed Deposit (FD) requires you to deposit a large, lump sum of money once for a fixed tenure, earning a higher interest rate than a regular savings account. A Recurring Deposit (RD) allows you to deposit a fixed, smaller amount every month for a set tenure, earning similar interest rates to an FD. Understanding the difference matters for planning your savings. Use an FD if you already have a lump sum saved up, and use an RD to build a habit of saving regularly out of your monthly income.',
  },
  {
    id: 'b3',
    category: 'banking',
    ...
    title: 'CIBIL Score',
    description:
      'A 3-digit number summarizing your credit history. A higher score improves loan approval chances.',
    fullDetails:
  ...
  },
  {
    ...
    description:
      'Many savings accounts require you to maintain a minimum average balance to avoid penalty charges.',
    fullDetails:
      'Most regular bank accounts require you to maintain an Average Monthly Balance (AMB). This concept matters because if your account balance falls below this stipulated limit, the bank will charge you a penalty fee, slowly eating into your savings. A practical tip: if you find it difficult to maintain a minimum balance, ask your bank to convert your account to a Basic Savings Bank Deposit Account (BSBDA) or open a PM Jan Dhan account, both of which legally have strict zero minimum balance requirements.',
  },
  {
    id: 'b5',
    category: 'banking',
  ...
  // Complaint Helpline
  {
    ...
    description:
      'Dial 1930 immediately if you suspect any financial cyber fraud to report the incident.',
    fullDetails:
      "The 1930 helpline is a critical, rapid-response resource managed by the Ministry of Home Affairs specifically for financial cyber frauds. It covers incidents where money has been deducted from your account without your consent via UPI, credit cards, or net banking. You should use it the moment you realize you have been scammed. By calling 1930 quickly (ideally within 2 to 3 hours), the authorities can trace the electronic transaction and attempt to freeze the stolen funds in the scammer's account before they can withdraw it.",
  },
  {
    id: 'h2',
    category: 'helpline',
  ...
  },
  {
    ...
    description:
      "Immediately call your bank's customer care to block your debit/credit card if it is lost or stolen.",
    fullDetails:
  ...
  },
  {
    ...
    description:
      "If your bank doesn't resolve your complaint within 30 days, file a complaint with the RBI.",
    fullDetails:
      'The Banking Ombudsman scheme is operated by the Reserve Bank of India (RBI) to resolve customer grievances. It covers issues like unauthorized charges, failed ATM transactions where money was deducted, or unsatisfactory customer service by your bank. You should use this only if you have already filed a formal written complaint with your bank and they have either rejected it or failed to provide a satisfactory resolution within 30 days. You can reach the Ombudsman and file a complaint for free online via the RBI CMS portal (cms.rbi.org.in).',
  },
];
