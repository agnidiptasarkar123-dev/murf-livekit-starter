    ...
    <div className="relative" ref={dropdownRef} style={{ zIndex: 50 }}>
      <button
        ...
        style={{
          ...
          background: '#f4f8f8', border: '1px solid #d1eff0',
          cursor: 'pointer', transition: 'all 0.2s',
          fontSize: 13, fontWeight: 600, color: '#0a3f42',
        }}
      ...
      {isOpen && (
        <div style={{
          ...
          background: '#ffffff', border: '1px solid #d1eff0',
          borderRadius: 12, boxShadow: '0 10px 25px rgba(13,110,115,0.1)',
          ...
          {languages.map((lang) => (
            <button
              ...
              style={{
                ...
                fontSize: 14, color: language === lang.code ? '#0d6e73' : '#374151',
