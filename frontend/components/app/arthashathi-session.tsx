    ...
    >
      <span
        style={{
          ...
          color: isUser ? C.slate500 : C.teal700,
          marginBottom: 4,
        }}
      >
    ...
    >
              ...
              style={{
                ...
                animation:
                  isConnecting || isSpeaking || isListening
                    ? 'arthashathi-dot 1.2s ease-in-out infinite'
                    : 'none',
              }}
            />
      ...
      <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {!isConnecting && !isSpeaking && !isListening && <ArthashathiLogo size={60} />}
              </motion.div>
            </AnimatePresence>
            <p
              style={{
        ...
        {(messages.length > 0 || isThinking) && (
          <section
            style={{ maxWidth: 900, width: '100%', margin: '0 auto', padding: '0 24px 16px' }}
          >
            <div
              style={{
                background: C.white,
                ...
                border: `1px solid ${C.teal100}`,
                overflow: 'hidden',
                boxShadow: '0 2px 16px rgba(13,110,115,0.07)',
              }}
            >
              <div
                style={{
              ...
              >
                ...
                {messages.map((msg, i) => (
                  <TranscriptBubble key={msg.id ?? i} msg={msg} youLabel={t('you')} />
                ))}
                {isThinking && (
                  <div
                    style={{
                      ...
                      {[0, 0.18, 0.36].map((d, i) => (
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: '50%',
                            background: C.teal700,
                            animation: `arthashathi-dot 1.1s ease-in-out ${d}s infinite`,
                          }}
                        />
                      ))}
                    </div>
        ...
        {/* ── FEATURE CARDS ── */}
        <section
          style={{ maxWidth: 900, width: '100%', margin: '0 auto', padding: '8px 24px 32px' }}
        >
          <div
            style={{
              display: 'grid',
          ...
          >
            {[
              ...
              >
                <span style={{ fontSize: 26 }}>{icon}</span>
                <p style={{ margin: 0, fontWeight: 700, fontSize: 14, color: C.teal900 }}>
                  {title}
                </p>
                <p style={{ margin: 0, fontSize: 12, color: C.slate500, lineHeight: 1.5 }}>
                  {desc}
                </p>
              </button>
            ))}
